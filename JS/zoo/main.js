...
const animalsById = (id) => {
  return zoo.animals.find((animal) => {
    return animal.id === id;
  });
};
...
const getEmployeeName = (id) => {
  ...
  return `El empleado se llama: ${employee.lastName}, ${employee.firstName}`;
};
//buscar empleado por array de ids
const getEmployees = (ids) => {
  const empleadosEcontrados = zoo.employees.filter((employee) =>
    ids.includes(employee.id)
  );
  return empleadosEcontrados;
};
...
//animal por id
const idAnimal = animalsById("0938aa23-f153-4937-9f88-4858b24d6bce");
console.log(idAnimal);
//empleado por id
const empleado = getEmployee("c5b83cb3-a451-49e2-ac45-ff3f54fbe7e1");
console.log(empleado);
//empleado por nombre
const NombreEmpleado = getEmployeeName("c5b83cb3-a451-49e2-ac45-ff3f54fbe7e1");
