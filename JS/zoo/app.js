...
//   return zoo.employees.find((employee) => {
//     return employee.id === id;
//   });
// };

// // getEmployee("0e7b460e-acf4-4e17-bcb3-ee472265db83");

// // buscador de empleados por array id

// const getEmployees = (ids) => {
//   return zoo.employees.filter((employee) => {
//     return ids.includes(employee.id);
//   });
// };

// //Animales que cuida un empleado

// const getEmployeeAnimals = (id) => {
//   const employee = getEmployee(id);
//   return zoo.animals.filter((animal) => {
//     return employee.responsibleFor.includes(animal.id);
//   });
// };

// getEmployeeAnimals("c5b83cb3 - a451 - 49e2 - ac45 - ff3f54fbe7e1");

// Nombres de managers por id de empleado
const getManagerNames = (employeeId) => {
  const employee = getEmployee(employeeId);
  return getEmployees(employee.managers).map((manager) => {
